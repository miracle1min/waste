                  ...
                  <Form {...form}>
                    <form ref={productFormRef} className="space-y-6 max-w-full md:max-w-2xl mx-auto">
                      ...
                      <div className="space-y-4 md:space-y-6">
                        ...
                        />
                        <FormField control={form.control} name="kodeProduk" render={({ field }) => (<FormItem><FormLabel>Kode Lot/Exp</FormLabel><FormControl><Input type="date" placeholder="Kode Lot" className="text-base min-h-[44px]" {...field} /></FormControl><FormMessage /></FormItem>)} />
                      </div>
                    ...
                    {itemRows.map((row, rowIndex) => (
                      <div key={rowIndex} className="border border-cyan-900/30 rounded-md p-3 space-y-2 bg-slate-900/40 relative">
                        ...
                        <div className="grid grid-cols-[1fr_0.6fr_0.6fr] gap-2">
                          <Input type="date" placeholder="Kode Lot" className="h-10 text-sm" value={row.kodeProduk} onChange={(e) => updateItemRow(rowIndex, 'kodeProduk', e.target.value)} />
