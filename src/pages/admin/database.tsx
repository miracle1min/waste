...
export default function DatabasePage() {
 ...
 {/* Info Banner */}
 <div className="rounded-2xl border border-purple-500/15 bg-gradient-to-br from-purple-500/5 via-[#9F7AEA]/[0.03] to-transparent p-5 sm:p-6">
 <div className="flex items-center gap-3 mb-2">
 <div className="w-10 h-10 rounded-xl bg-purple-500/10 flex items-center justify-center">
 <Server className="w-5 h-5 text-purple-400" />
 </div>
 <div>
 <h3 className="text-base font-bold font-sans text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-[#9F7AEA]">Database Management</h3>
 <p className="text-[11px] text-[#4FD1FF]/60 font-sans">Seed database untuk store baru</p>
 </div>
 </div>
 </div>
 ...
 <CardHeader>
 <h4 className="text-sm font-sans font-bold text-[#4FD1FF]">Seed Tenant Database</h4>
 <p className="text-[10px] font-sans text-[#4FD1FF]/60 mt-0.5">Bikin tabel (users, personnel, tenant_configs) di database baru</p>
 </CardHeader>
 ...
 <Card className="overflow-hidden">
 <CardHeader>
 <h4 className="text-sm font-sans font-bold text-[#4FD1FF]">Status per Store</h4>
 </CardHeader>
 ...
 <li>• Pastikan pakai <code className="text-[#4FD1FF] bg-[#4FD1FF]/8 px-1 rounded">?sslmode=require</code></li>
 </ul>
 </Card>
 </div>
 );
