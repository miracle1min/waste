...
export default function GoogleUsersPage() {
  ...
  return (
    <div className="space-y-5">
      {/* Hero */}
      <HeroBanner icon={Globe} title="Google Users" subtitle={`${googleUsers.length} akun Google terhubung`} />
          ...
          <Card className="hidden sm:block overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm font-sans">
                ...
                <tbody>
                  {filtered.map((g) => (
                    <tr key={g.id} className="border-b border-[#4FD1FF]/8 hover:bg-[#4FD1FF]/[0.02] transition-colors">
