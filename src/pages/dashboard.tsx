  ...
  for (let shiftIdx = 0; shiftIdx < shifts.length; shiftIdx++) {
    ...
    autoTable(doc, {
      ...
      columnStyles: {
        ...
        1: { cellWidth: 30 }, 2: { cellWidth: 18 },
        3: { cellWidth: 12, halign: 'center' }, 4: { cellWidth: 14, halign: 'center' },
        5: { cellWidth: 18 }, 6: { cellWidth: 26 },
        7: { cellWidth: 18 }, 8: { cellWidth: 16, halign: 'center' },
        9: { cellWidth: 18, halign: 'center' }, 10: { cellWidth: 12, halign: 'center' },
      },
      tableWidth: 'auto', theme: 'grid',
